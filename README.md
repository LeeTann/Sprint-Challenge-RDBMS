...
RDBMS is a specialized software we use to manage digital databases. SQL is a standard query language used to manage the data in the database.

1. Why do tables need a `primary key`?

We need primary keys to uniquely identify each record in a table. 
...
We need to crated a third table that holds foreign keys that references the primary key on the related tables.
